...
create_menu (void)
{
  ...
  rh = gtk_label_new_with_mnemonic (_("Client"));
  gtk_widget_show (rh);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), actualiser, 888, 232);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), btn_search, 888, 296);
...
create_ajouter (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed20), back_ajo_btn, 0, 48);
  ...
  GLADE_HOOKUP_OBJECT (ajouter, fixed15, "fixed15");
  GLADE_HOOKUP_OBJECT (ajouter, label25, "label25");
  GLADE_HOOKUP_OBJECT (ajouter, fixed16, "fixed16");
  GLADE_HOOKUP_OBJECT (ajouter, input_tel, "input_tel");
  GLADE_HOOKUP_OBJECT (ajouter, fixed17, "fixed17");
  ...
  GLADE_HOOKUP_OBJECT (ajouter, fixed20, "fixed20");
